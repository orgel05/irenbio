...
<link rel="stylesheet" type="text/css" href="/bio/css/style.css">
	...
	<script type="text/javascript">
	    ...
	    function go_view(no){
	    	location.href="/bio/office/page/cert_view.php?idx="+no;

	    }
	    function go_add() {
	    	location.href="/bio/office/page/cert_add.php";
	    	// body...
	    }
	</script>
	<style type="text/css">
        ...
        <div class="contentArea">
        	<table cellpadding="0" cellspacing="0" class="AXFormTable">
        		...
        		<tr>
        			...
        			<th style="width:50px;"> <div class="tdRel">제목</div></th>			
        			<th style="width:30px;"><div class="tdRel">이미지</div></th>
        			<th style="width:100px;"><div class="tdRel">내용</div></th>
        		</tr>
        	...
        	<? while ($row = mysql_fetch_array($result)) {
				...
				<tr height="35" bgcolor="#ffffff" onmouseover="this.style.background='#E8EEC6'" onmouseout="this.style.background='#ffffff'" onclick="go_view('<?=$row['no']?>');" style="text-align: center;cursor: pointer;">
        			<td ><?=$row['no']?></td>
        			<td ><?=$row['c_name']?></td>
        			<td><img src="/bio/img/<?=$row['c_img']?>" style="height:200px; "></td>
        			<td><?=$row['c_info']?></td>
