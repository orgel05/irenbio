...
<link rel="stylesheet" type="text/css" href="/bio/css/style.css">
	...
	<script type="text/javascript">
	    ...
	    function go_mo(no){
	    	location.href="/bio/office/page/news_modify.php?idx="+no;

	    }
	    function go_add() {
	    	location.href="/bio/office/page/news_add.php";
	    	// body...
	    }
	    function go_del(no){
			...
			var	con = confirm("정말로 삭제하시겠습니까?");
 			if (con==true){
  			 	location.href="/bio/office/page/news_del.php?idx="+no;	} 
  			else {location.href="#"}
		}
		function go_list(){
	
  			 	location.href="/bio/office/page/news_list.php";	
		}
