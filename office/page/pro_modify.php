...
*/ 
	...
	$sql = "UPDATE pro1 SET p_type='$p_type',p_name='$p_name',p_img='$p_img' ,view='$view',p_intro='$p_intro',p_area='$p_area',p_use='$p_use',p_mul='$p_mul',p_way='$p_way',p_feat='$p_feat' where no='$idx'";
...
<body>
	...
	<div class="masterBody" id="masterBody">
        ...
        <div class="contentArea">
        	<div >
        	<form name="insert" method="post" action="./pro_modify.php?idx=<?=$row['no']?>" enctype="multipart/form-data">
        		...
        		<tr><th><div class="tdRel">이미지</div></th>
        			<td><input type="file" name="p_img" value="<?=$row['p_img']?>" />
        			<img src="../upload/<?=$_FILES['abc']['name']?>" /></td></tr>
        		...
        		<tr><th><div class="tdRel">희석배수</div></th>
        			<td><textarea name="p_mul" id="p_mul" rows="10" cols="100" style="width:766px; height:412px; display:none;"><?=$row['p_mul']?></textarea></td>
        		</tr>
        		<tr><th><div class="tdRel">효과</div></th>
        			<td><textarea name="p_way" id="p_way" rows="10" cols="100" style="width:766px; height:412px; display:none;"> <?=$row['p_way']?></textarea></td>
        		</tr>
        		<tr><th><div class="tdRel">특징</div></th>
        			<td><textarea name="p_feat" id="p_feat" rows="10" cols="100" style="width:766px; height:412px; display:none;"><?=$row['p_feat']?></textarea>></td>
        		</tr>
        		</table>
        		<div class="bnt_go" style="width:500px; ">
			<button  class="AXButton Blue" onclick="submitContents(insert)">수정하기</button>
