...
if($_POST['mode']=='up'){
	...
	$ir2=htmlspecialchars_decode($ir1);
	...
	<div class="masterBody" id="masterBody">
        ...
        <div class="contentArea">
        	<form name="test" action="test.php" method="post">
        		...
        		<p>제목 : <input type="text" name="subject" class="AXInput" style="width:300px; "></p>
	<textarea name="ir1" id="ir1" rows="10" cols="100" style="width:766px; height:412px;display: none;"></textarea>
	<p><input type="button" value="확 인" class="AXButton Red" onClick="submitContents(this);"></p>
</form>
		</div>
</body>
<script type="text/javascript">
...
<script type="text/javascript" src="/bio/lib/smarteidtor2/dist/js/service/HuskyEZCreator.js" charset="utf-8"></script>
