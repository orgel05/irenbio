...
if($_POST['mode']=='up'){
	...
	$c_info=$_POST['ir1'];
	$c_img=$_FILES['data']['name'];
	$sql = "INSERT INTO iren_cer(c_name,c_img,c_info) VALUES('$c_name','$c_img','$c_info')";

	   $result=mysql_query($sql,$connect);
			 echo '<script>location.href="cert_list.php"</script>';
	   mysql_error();
...
<form action="cert_add.php" method="post" name="insert" " enctype="multipart/form-data">
	...
	<p>
		...
		<input type="button" onclick="submitContents(this);" value="입력완료" />
