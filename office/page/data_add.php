...
if($_POST['mode']=='up'){
	...
	$sql = "INSERT INTO iren_data(title,p_id,date,data,contents) VALUES('$title','$p_id','$p_date','$data','$contents')";
...
<form action="data_add.php" method="post" name="insert" " enctype="multipart/form-data">
	...
	<label>제목 : </label>	<input type="text" name="title" class="AXInput" style="width:730px;border:1px solid gray;">
	</div>
	...
	<p>
		...
		<div style="margin:auto;position: relative; text-align:center;margin-top:10px;">
				...
				<input type="button" onclick="submitContents(this);" class="AXButton Red" value="입력완료" />
