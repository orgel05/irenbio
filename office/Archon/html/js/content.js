var masterMenu = {
	tree:[
		...
		{label:"자료관리", addClass:"icon05", subTree:[
			{programID:"DATA1", label:"인증서", url:"/bio/office/cert_list.php", target:"_self"},
			{programID:"DATA1", label:"제품", url:"/bio/office/pro_list.php", target:"_self"}
		]},
		{label:"게시판", addClass:"icon06", subTree:[
			{programID:"BBS1", label:"문의사항", url:"#", target:"_self"},
			{programID:"BBS2",	label:"자료실",	url:"#", target:"_self"},
			{programID:"BBS3", label:"이렌뉴스",	url:"#", target:"_self"}
		]},
		{label:"설정관리", addClass:"icon08", subTree:[
			{programID:"CODE01", label:"관리자관리", url:"#", target:"_self"},
		//	{programID:"CODE02", label:"관리자상세보기", url:"#", target:"_self"},
		//	{programID:"CODE03", label:"관리자추가", url:"#", target:"_self"}
		]}
	],
